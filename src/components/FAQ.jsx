  ...
  return (
    <div className="md:pb-16 pb-32">
      ...
      <div className="px-12 mt-12">
        ...
        <Answer text="Yes! Because of the poodle bloodline in them, they are considered hypoallergenic. Since their dad Lumi is a pure bread standard poodle and their mom Luna also is 50% poodle, the pups are even more hypoallergenic than most doodles." />
